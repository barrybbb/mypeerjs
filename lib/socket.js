 ...
 */
function Socket(secure, host, port, key, nickname) {
  if (!(this instanceof Socket)) return new Socket(secure, host, port, key, nickname);
util.log('Socket NickNameo: ',nickname);
  ...
  this._httpUrl = httpProtocol + host + ':' + port + '/' + key + '/' + nickname;
  this._wsUrl = httpProtocol + host + ':' + port + '/peerjs?key=' + key+'&nickname='+nickname;
}
