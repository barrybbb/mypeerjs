...
function Peer(id, options) {
  ...
  // websockets.)
  var self = this;
  this.socket = new Socket(this.options.secure, this.options.host, this.options.port, this.options.key, this.options.nickname);
  util.log('Nick name: ',this.options.nickname);
...
Peer.prototype._retrieveId = function(cb) {
  ...
  var url = protocol + this.options.host + ':' + this.options.port + '/' + this.options.key + '/' +this.options.nickname +'/id';
...
Peer.prototype._handleMessage = function(message) {
  ...
  switch (type) {
    ...
    case 'ID-TAKEN': // The selected ID is taken.
      ...
      break;
	case 'NEW-USER': // Found New User.
      this.emit('newuser', payload.id, payload.nickname);
      break;
